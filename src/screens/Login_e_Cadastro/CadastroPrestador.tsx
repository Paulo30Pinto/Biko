import { FormControl, HStack, Text, VStack, ScrollView } from "native-base";
...
export function CadastroPrestador({...rest}: Props) {
                ...
                <VStack>
                    ...
                    <HStack px={5} mb={2}>
                        ...
                        <Input
                            ...
                            placeholder="Explicador, Eletricista, Técnico de frio..."
                            />
